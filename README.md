...
----
This is a simple Android application written to teach various concepts in Android Development for my students. The application demonstrates the following concepts. 
